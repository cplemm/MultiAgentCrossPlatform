# Connect shipment-recovery-orchestrator to Microsoft Teams

`azd deploy` already did the Azure side for you:

- Azure Bot: `shipment-recovery-orchestrato-bot-38dda37c` (Microsoft Teams channel enabled)
- Bot ID (msaAppId): `01a2446d-e31b-4dc3-be21-56b38068b083`
